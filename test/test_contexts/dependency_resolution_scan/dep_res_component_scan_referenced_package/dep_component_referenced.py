...
@component()
class DepProfileComponentReferencedFromPackage:
    ...
    def build_test_config(cls):
        return DepProfileComponentReferencedFromPackage("test")

    @classmethod
    @bean(self_factory=True, profile='validation', scope=profile_scope)
    def build_validation_config(cls):
        return DepProfileComponentReferencedFromPackage("validation")
